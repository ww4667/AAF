 ...
 * @updated 2010-07-21
 */
$_lang['access_category_management_msg'] = 'จัดการสมาชิกกลุ่มผู้ใช้ในการเข้าถึงอิเลเมนต์ผ่านทางหมวดหมู่และตัวเสริมการประยุกต์นโยบายการเข้าถึงข้อมูล';
...
$_lang['access_category_update'] = 'ปรับปรุงการเข้าถึงหมวดหมู่';
...
$_lang['access_context_update'] = 'ปรับปรุงการเข้าถึงบริบท';
...
$_lang['access_permissions_off'] = '<span class="warning">สิทธิ์การเข้าถึงไม่ถูกใช้งาน</span> หมายความว่าการเปลี่ยนแปลงใดๆ ที่เกิดขึ้นตรงนี้จะไม่มีผลใดๆ จนกว่าสิทธิ์การเข้าถึงจะถูกใช้งาน';
$_lang['access_permissions_users_in_group'] = '<strong>ผู้ใช่ในกลุ่ม:</strong> ';
$_lang['access_permissions_users_tab'] = 'คุณสามารถดูว่ากลุ่มผู้ใช้ไหนถูกสร้างขึ้น อีกทั้งยังสามารถสร้างกลุ่มใหม่ เปลี่ยนชื่อกลุ่ม ลบกลุ่ม ดูว่าผู้ใช้ที่อยู่ต่างกลุ่มกันได้ เพิ่มผู้ใช้ใหม่เข้ากลุ่มหรือลบผู้ใช้ออกจากกลุ่ม และแก้ไขผู้ใช้ได้โดยตรง';
$_lang['access_permissions_user_group'] = 'กลุ่มผู้ใช้:';
$_lang['access_permissions_user_groups'] = 'กลุ่มผู้ใช้';
...
$_lang['access_rgroup_update'] = 'ปรับปรุงการเข้าถึงกลุ่มรีซอร์ส';
$_lang['access_to_contexts'] = 'เข้าถึงบริบท';
$_lang['access_to_resource_groups'] = 'เข้าถึงกลุ่มรีซอร์ส';
...
$_lang['roles_msg'] = 'บทบาท คือ โดยตามนิยามหมายถึงตำแหน่งหรือสถานะของคนๆ หนึ่งที่ถือครองภายในสถานะการณ์นั้นๆ  ซึ่งพวกเขาสามารถใช้ในการจัดกลุ่มผู้ใช้เข้าสู่ตำแหน่งหรือสถานะภายในกลุ่มผู้ใช้ บทบามใน MODx ยังมีที่เรียกว่า "อำนาจ" คือค่าตัวเลขที่สามารถเป็นตัวเลขจำนวนเต็มใดๆ ระดับอำนาจคือ "สืบทอดลง" ในแง่ที่ว่าบทบาทที่มีอำนาจเป็น 1 จะรับช่วงทั้งหมดและนโยบายกลุ่มทั้งหมดมอบหมายให้ตัวเองและบทบาทอื่นๆ ที่มีอำนาจสูงกว่า 1';
$_lang['user_group_category_access'] = 'การเข้าถึงหมวดหมู่อิเลเมนต์';
$_lang['user_group_category_access_msg'] = 'คุณสามารถตั้งค่าอิเลเมนต์ที่คุณต้องการให้กลุ่มผู้ใช้สามารถเข้าถึงได้โดยหมวดหมู่ที่มีอิเลเมนต์นั้นอยู่';
