...
$_lang['credits_xpdo'] = 'MODx ใช้ เทคโนโลยีในการแปลงวัตถุในรูปแบบฐานข้อมูลเชิงสัมพันธ์ <a href="http://www.xpdo.org/" target="_blank">xPDO</a>';
$_lang['help_msg'] = '<p>คุณสามารถรับความช่วยเหลือจากคอมมิวนิตีได้ฟรีโดยเข้าไปที่ <a href="http://modxcms.com/forums/" target="_blank">MODx Forums</a> อีกทั้งยังมีการเพิ่มเนื้อหาในเอกสารประกอบของ <a href="http://docs.modxcms.com/display/revolution" target="_blank"> MODx Revolution</a></p><p>หากพบพบข้อผิดพลาดแล้วกรุณาแจ้งให้เราทราบที่ <a href="http://bugs.modxcms.com/" target="_blank">MODx\'s JIRA Issue Tracker</a></p>';
$_lang['help_title'] = 'ช่วยเหลือ';