...
$_lang['template_err_delete'] = 'เกิดข้อผิดพลาดขณะกำลังลบแม่แบบ';
$_lang['template_err_duplicate'] = 'เกิดข้อผิดพลาดขณะกำลังทำสำเนาแม่แบบ';
$_lang['template_err_exists_name'] = 'ชื่อแม่แบบนี้มีอยู่แล้ว';
...
$_lang['template_msg'] = 'สร้างและแก้ไขแม่แบบ การเปลี่ยนหรือสร้างแม่แบบใหม่จะไม่เห็นผลในหน้าเว็บไซต์ที่แคชไว้จนกว่าไฟล์แคชจะถูกล้าง แต่อย่างไรก็ได้ตามคุณสามารถใช้ฟังก์ชันพรีวิวเพื่อทดสอบดูได้';
...
$_lang['template_title'] = 'สร้าง/แก้ไข แม่แบบ';
$_lang['template_tv_edit'] = 'แก้ไขการจัดเรียงลำดับของตัวแปรแม่แบบ';
$_lang['template_tv_msg'] = 'ตัวแปรแม่แบบที่ถูกกำหนดให้กับแม่แบบนี้แสดงเป็นรายการข้างล่าง';
$_lang['template_untitled'] = 'แม่แบบไม่มีชื่อ';
