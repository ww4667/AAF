...
$_lang['category_err_nfs'] = 'ไม่พบหมวดหมู่ที่มีคีย์เป็น %s';
$_lang['category_err_ns'] = 'ไม่มีหมวดหมู่ที่ระบุ';
$_lang['category_err_ns_name'] = 'กรุณาระบุชื่อหมวดหมู่ที่ถูกต้องเหมาะสม';
$_lang['category_err_remove'] = 'เกิดข้อผิดพลาดขณะที่พยายามลบหมวดหมู่';
