		...
		<h2><strong>We've received your Event Submission!</strong></h2>
            ...
            <tr>
              <td bgcolor="#F5F5F5" style="background-color:#F5F5F5;font-size:12px;font-family:Arial, Helvetica, sans-serif;line-height:20px;color:#666">
				<!--BODY CONTENT START-->
				 ...
				 <p>We've received your event submission. After we review the information provided we will send an email with your event posting status and further instructions.
				 <ul>				 	
				 <? foreach ( $object['event_data'] as $key => $val ) { ?>
					 <? if ( $key != "x" && $key != "y" ) { ?>
